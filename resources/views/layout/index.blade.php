...
<div class="wrapper">
  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav">
      ...
      <div >
        <img src="{{asset('assets/images/iconn.png')}}" alt="Logo UMY">
      </div>
      <div class="title">
           Tanaman Hias
        </div>
    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="/listtanaman" class="nav-link">
          ...
          <li class="nav-item">
            <a href="/daftarpemesanan" class="nav-link">
              <i class="nav-icon fas fa-book"></i>
              <p>
               Pesanan
              </p>
          ...
          <li class="nav-item">
            <a href="/daftarpemasukan" class="nav-link">
          ...
          <!-- <li class="nav-item">
            <a href="daftarpengeluaran" class="nav-link">
              <i class="nav-icon fas fa-file"></i>
              <p>
                pengeluaran
              </p>
...
<div class="content-wrapper">
  ...
  <footer class="main-footer">
    <strong>Copyright &copy; 2020 SistemAdminTokoTanamanHias ● SitiKhotimah </strong>
